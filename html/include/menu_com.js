...
*	All comments including this one may be deleted						*
...
*		 added HideTop to allow first level items to remain visible in frame setup			*
...
*	Version 4.2 Allows different background and font colors on sub elements				*
*	Version 4.2.1 Code optimized, Executes existing onloads					*
*	Version 4.3 Added UnfoldsOnClick 1/0. Level 1 opens onclick or onmouseover, background images	*
*		_var.js file no longer compatible							*
*	Version 4.4 Added functions BeforeStart & AfterBuild to _var.js					*
*	Version 5    Supports rollover images							*
**********************************************************************************************************************************************/
...
function ClcLft(){			// Calculates StartTop and Left when menu is centered
	if(MenuCentered!='left'){
		...
		StartLeft=M_StrtLft;
		StartLeft+=(Size>0)?(MenuCentered=='right')?Size:Size/2:0
		}}
...
function MbrSetUp(MmbrCntnr,PrMmbr,WhatMenu,Wdth,Hght){ // Sets up element IE & NS6
	...
	if(eval(WhatMenu+'[3]')){
		S=(RcrsLvl==1&&FirstLineHorizontal)?'http://www.ece.mcmaster.ca/~reilly/html/images/tridown.gif':(RightToLeft)?'http://www.ece.mcmaster.ca/~reilly/html/images/trileft.gif':'http://www.ece.mcmaster.ca/~reilly/html/images/tri.gif';
...
function NavMbrSetUp(MmbrCntnr,PrMmbr,WhatMenu,Wdth,Hght){ // Sets up element IE & NS6
	...
	if(eval(WhatMenu+'[3]')){
		...
		ImgStr=(RcrsLvl==1&&FirstLineHorizontal)?"<img src='http://www.ece.mcmaster.ca/~reilly/html/images/tridown.gif'>":(RightToLeft)?"<img src='http://www.ece.mcmaster.ca/~reilly/html/images/trileft.gif'>":"<img src='http://www.ece.mcmaster.ca/~reilly/html/images/tri.gif'>";
